...
/**
 * HTTP smoke test for EventController. The configured route group
 ...
 * @internal
 */
final class EventControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/events/events');
    ...
    {
        $result = $this->get('/api/v1/events/events/99999');
    ...
    {
        $result = $this->get('/api/v1/events/dashboard/summary');
