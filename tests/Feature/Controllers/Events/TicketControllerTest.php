...
/**
 * HTTP smoke test for TicketController. The configured route group
 ...
 * @internal
 */
final class TicketControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/events/tickets');
    ...
    {
        $result = $this->get('/api/v1/events/tickets/99999');
