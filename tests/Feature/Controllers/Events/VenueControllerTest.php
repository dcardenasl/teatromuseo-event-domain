...
/**
 * HTTP smoke test for VenueController. The configured route group
 ...
 * @internal
 */
final class VenueControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/events/venues');
    ...
    {
        $result = $this->get('/api/v1/events/venues/99999');
