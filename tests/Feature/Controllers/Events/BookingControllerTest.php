...
/**
 * HTTP smoke test for BookingController. The configured route group
 ...
 * @internal
 */
final class BookingControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/events/bookings');
    ...
    {
        $result = $this->get('/api/v1/events/bookings/99999');
