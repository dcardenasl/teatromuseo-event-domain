...
/**
 * HTTP smoke test for TicketTypeController. The configured route group
 ...
 * @internal
 */
final class TicketTypeControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/events/ticket-types');
    ...
    {
        $result = $this->get('/api/v1/events/ticket-types/99999');
