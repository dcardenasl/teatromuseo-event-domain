...
/**
 * HTTP smoke test for EventReferenceController. The configured route group
 ...
 * @internal
 */
final class EventReferenceControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/events/event-references');
    ...
    {
        $result = $this->get('/api/v1/events/event-references/99999');
