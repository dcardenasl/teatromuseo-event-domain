...
/**
 * HTTP smoke test for OccurrenceController. The configured route group
 ...
 * @internal
 */
final class OccurrenceControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/events/occurrences');
    ...
    {
        $result = $this->get('/api/v1/events/occurrences/99999');
