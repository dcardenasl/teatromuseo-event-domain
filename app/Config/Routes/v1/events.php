...
$routes->group('events', ['namespace' => '\App\Controllers\Api\V1\Events'], function ($routes): void {
    ...
    $routes->group('', ['filter' => ['domainauth', 'throttle']], function ($routes): void {
        ...
        $routes->group('', ['filter' => 'permission:event-references.write'], function ($routes): void {
        ...
        $routes->group('', ['filter' => 'permission:event-references.delete'], function ($routes): void {
        ...
        $routes->group('', ['filter' => 'permission:ticket-types.delete'], function ($routes): void {
        ...
        $routes->group('', ['filter' => 'permission:bookings.delete'], function ($routes): void {
        ...
        $routes->group('', ['filter' => 'permission:tickets.delete'], function ($routes): void {
