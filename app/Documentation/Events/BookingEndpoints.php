...
/**
 * OpenAPI definitions for Booking endpoints.
 *
...
class BookingEndpoints
{
                ...
                content: new OA\JsonContent(
                    properties: [
                        ...
                        new OA\Property(
                            property: 'data',
                            type: 'array',
                            items: new OA\Items(ref: '#/components/schemas/BookingResponse')
                        ),
                    ],
                    type: 'object'
                )
    ...
    #[OA\Get(
        path: '/api/v1/events/bookings/{id}',
        tags: ['Events'],
    ...
    #[OA\Put(
        ...
        requestBody: new OA\RequestBody(
            required: true,
            content: new OA\JsonContent(ref: '#/components/schemas/BookingUpdateRequest')
        ),
        responses: [
            new OA\Response(
                response: 200,
