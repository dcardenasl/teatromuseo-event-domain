...
/**
 * OpenAPI definitions for EventType endpoints.
 *
 * @OA\Tag(name="Events", description="Events management")
 */
class EventTypeEndpoints
{
    #[OA\Get(
    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(
            required: true,
            content: new OA\JsonContent(ref: '#/components/schemas/EventTypeCreateRequest')
        ),
        responses: [
    ...
    #[OA\Get(
        path: '/api/v1/events/event-types/{id}',
        tags: ['Events'],
        ...
        responses: [
            new OA\Response(
                response: 200,
                description: 'Found',
                content: new OA\JsonContent(ref: '#/components/schemas/EventTypeResponse')
            ),
